	...
	async function goldRetriever() {
		...
		for (let i = 0; i < puppetList.length; i++) {
			...
			try {
				...
				content += `<tr><td><p><a target='_blank' href='https://${localStorage.getItem("connectionUrl") || "www"}.nationstates.net/container=${nation_formatted}/nation=${nation_formatted}'>${deck.nation}</a></p></td><td><p><a target='_blank' href='https://${localStorage.getItem("connectionUrl") || "www"}.nationstates.net/page=deck/container=${nation_formatted}/nation=${nation_formatted}/value_deck=1'>${deck.bank}</a></p></td><td><p><a target='_blank' href='https://${localStorage.getItem("connectionUrl") || "www"}.nationstates.net/page=deck/container=${nation_formatted}/nation=${nation_formatted}/value_deck=1'>${deck.deckValue}</a></p></td><td><p><a target='_blank' href='https://${localStorage.getItem("connectionUrl") || "www"}.nationstates.net/page=deck/container=${nation_formatted}/nation=${nation_formatted}'>${deck.junkValue}</a></p></td><td><p><a target='_blank' href='https://${localStorage.getItem("connectionUrl") || "www"}.nationstates.net/page=deck/container=${nation_formatted}/nation=${nation_formatted}'>${deck.cardCount}</a></p></td>${mode === "Include" ? `<td><p><a target='_blank' href='https://${localStorage.getItem("connectionUrl") || "www"}.nationstates.net/page=dilemmas/container=${nation_formatted}/nation=${nation_formatted}'>${deck.issues}</a></p></td><td><p><a target='_blank' href='https://${localStorage.getItem("connectionUrl") || "www"}.nationstates.net/page=deck/container=${nation_formatted}/nation=${nation_formatted}'>${deck.packs}</a></p></td>` : "" }</tr>\n`;
			} catch (err) {
