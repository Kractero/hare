...
export const tools: Array<Tool> = [
	...
	},
	{
		...
		slug: 'transfer',
		description:
			'Takes a bank threshold and receive a text file with puppets that have that bank or higher.',
	},
	{
		name: 'Containerise',
		slug: 'containerise',
	...
	},
	{
		...
		slug: 'signal',
		description:
			'Given card ids, provide decks, collections, or check asks and bids for what is missing. Sideroca compatible.',
	},
	{
		name: 'Deck to IDs',
		slug: 'deck',
	...
	},
	{
		...
		slug: 'statistics',
		description:
			'Provided WA scales and puppets, get the mean, median, and mode for each scale. (WIP)',
	},
	{
		name: 'Creation Assistant',
		slug: 'creation',
		description:
			'Generate a sheet that has links for nation creation that works with the provided userscripts.',
	},
	{
		name: 'Orphans',
		slug: 'orphans',
