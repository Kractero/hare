...
All you need now to get started is a userscript manager.
...
<div class="flex gap-4 justify-center">
    <a href="https://addons.mozilla.org/en-US/firefox/addon/tampermonkey/" rel="noopener noreferrer" target="_blank">
        <img style="background: #e8e8e8;" src="https://addons.mozilla.org/user-media/addon_icons/683/683490-64.png?modified=1625638973" alt="TamperMonkey" />
    </a>
</div>
...
<video width="320" height="320" controls>
  <source src="/Tampermonkey.mp4" type="video/mp4">
</video>

To add a script to TamperMonkey, simply click the TamperMonkey icon in your toolbar and select "Create a new script." Additionally, most userscript links will automatically open in TamperMonkey.
...
## <a name="optional">Legacy Tools</a>

You probably don't need to read these, they are kept for historical purposes
